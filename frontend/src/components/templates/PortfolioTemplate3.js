            ...
            <section id="about" className="mb-48 scroll-mt-32">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                <div className="lg:col-span-4">
                  ...
                  <div className="aspect-square w-32 md:w-48 overflow-hidden rounded-full mb-8 border-4 border-white shadow-lg">
                    <img src={avatarUrl || "https://images.unsplash.com/photo-1520333789090-1afc82db536a?auto=format&fit=crop&q=80&w=600"} className="w-full h-full object-cover" />
                  </div>
                </div>
                <div className="lg:col-span-8">
                  <p 
                  ...
                  >
                    <div className="w-full lg:w-7/12">
                      <a href={project.link || "#"} target="_blank" rel="noopener noreferrer" className="block relative group overflow-hidden shadow-2xl rounded-sm">
                        <div className="aspect-[4/3] md:aspect-[16/9] overflow-hidden grayscale hover:grayscale-0 transition-all duration-700">
                          {project.image ? (
